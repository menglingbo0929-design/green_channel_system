...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'arrears', name: 'Arrears', redirect: { path: '/member4/school-business', query: { tab: 'arrears' } }, meta: { title: '欠费确认', roles: ['SCHOOL'] } },
      { path: 'supplement', name: 'Supplement', redirect: { path: '/member4/school-business', query: { tab: 'supplement' } }, meta: { title: '申请补录', roles: ['SCHOOL'] } },
      { path: 'stats', name: 'Stats', redirect: '/member4/statistics-dashboard', meta: { title: '统计报表', roles: ['SCHOOL', 'COLLEGE'] } },
