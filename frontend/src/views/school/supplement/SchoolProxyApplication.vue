...
const upload = async () => { loading.value = true; await uploadProxyAttachment(result.value.applicationId, selectedFile.value, uuid(), userStore.userId); attachmentUploaded.value = true; loading.value = false }
