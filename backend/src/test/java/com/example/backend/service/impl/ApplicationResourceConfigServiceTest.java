...
import com.example.backend.model.dto.BatchGiftItemCommand;
import com.example.backend.model.dto.GiftQuotaCommand;
...
class ApplicationResourceConfigServiceTest {
    ...
    void validatesCollegeThroughOrganizationServiceBeforeCreatingQuota() {
        ...
        when(mapper.findCollegeGiftQuota(9L)).thenReturn(new com.example.backend.model.dto.GiftQuotaView(9L, 3L, null, 8L, null, 10, 0, 0, 0));
