...
import com.example.backend.common.exception.ApprovalIntegrationUnavailableException;
...
public class SystemMessageController {
    ...
    private final ObjectProvider<ICurrentUserProvider> currentUserProvider;
    private final ObjectProvider<SystemMessageService> messageServiceProvider;

    public SystemMessageController(
            ObjectProvider<ICurrentUserProvider> currentUserProvider,
    ...
    private com.example.backend.model.dto.LoginUser currentUser() {
        ICurrentUserProvider provider = currentUserProvider.getIfAvailable();
