...
public class ApplicationResourceServiceImpl implements ApprovalResourceService {
    ...
    private void reserveGifts(Application application, StudentApplicationProfile student) {
        List<com.example.backend.model.dto.GiftApplicationItemSnapshot> items = resources.findGiftItems(application.getId());
    ...
    private com.example.backend.model.dto.SubsidyApplicationSnapshot requiredSubsidy(Long applicationId) { var subsidy = resources.findSubsidy(applicationId); if (subsidy == null) throw invalid("APPLICATION_SUBSIDY_REQUIRED", "申请缺少补助明细"); return subsidy; }
